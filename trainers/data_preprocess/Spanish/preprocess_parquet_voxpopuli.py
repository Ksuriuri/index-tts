    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                for batch_data in parquet_file.iter_batches(batch_size=256, columns=['audio', 'raw_text', 'normalized_text', 'speaker_id']):
                    ...
                    raw_text_col = batch_data['raw_text']
                    norm_text_col = batch_data['normalized_text']
                    ...
                    for i in range(len(batch_data)):
                        ...
                        try:
                            ...
                            if not text:
                                text = str(norm_text_col[i]).strip() if norm_text_col[i] is not None else ""
                            if not text:
                                no_text_count += 1
                                continue
